<?php
   ...
   class CommonDbFunction extends AbstractDbFunction {
      ...
      public function determineCurrentUser() {
         ...
         $query = "select  u.user, u.role, u.raceFk, r.name as raceName from User u join Session s join Race r on u.userId = s.userFk and u.raceFk = r.raceId where sessionId = ?";
