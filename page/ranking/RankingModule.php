   ...
   class RankingModule implements Module {
      ...
      public function RankingModule() {
         $this->pages = array(
            ...
            new ModulePage("taskDetail", "Manifest Detail", array(Role::RACE_MASTER, Role::DISPATCHER, Role::CHECKPOINT, Role::NO_ROLE), null, false, false, array( "racerTask/RacerTask", "race/Delivery" ) ),
