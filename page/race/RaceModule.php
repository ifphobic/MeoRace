   ...
   class RaceModule implements Module {
      ...
      public function RaceModule() {
         $this->pages = array(
            ...
            new ModulePage("deliveryDelete", "Delete Delivery", array(Role::RACE_MASTER), array(Role::RACE_MASTER), true, false, array("race/Delivery") ),
            ...
            new ModulePage("deliveryConditionDelete", "Delete Delivery Condition", array(Role::RACE_MASTER), array(Role::RACE_MASTER), false, false, array("race/DeliveryCondition") ),
         );
      }
